...
.method private checkPermission(Landroid/net/Uri;)Z
    ...
    const-string v3, "remind: provider.query() returns cursor == null"
    ...
    const-string v3, "remind: acquireProvider() returns provider == null"
...
.method private final getDummyResult(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/content/IContentProvider;)Landroid/database/Cursor;
    ...
    .local v3, selectStr:Ljava/lang/String;
    :goto_0
    const/4 v6, 0x0
    ...
    invoke-virtual {p0, p6}, Landroid/content/ContentResolver;->releaseProvider(Landroid/content/IContentProvider;)Z

    .end local v3           #selectStr:Ljava/lang/String;
    :goto_1
    return-object v0
    ...
    .restart local v3       #selectStr:Ljava/lang/String;
    goto :goto_0
...
.method private insertLog(Landroid/content/IContentProvider;IIZ)V
    ...
    const-string v3, "permissionCode"
