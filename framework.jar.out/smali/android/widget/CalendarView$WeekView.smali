...
.method private drawSelectedDateVerticalBars(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0}, Landroid/widget/CalendarView;->access$3500(Landroid/widget/CalendarView;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Landroid/widget/CalendarView;->access$3400(Landroid/widget/CalendarView;)I
...
.method private drawWeekNumbersAndDates(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroid/widget/CalendarView;->access$3200(Landroid/widget/CalendarView;)I
...
.method private drawWeekSeparators(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v3}, Landroid/widget/CalendarView;->access$3300(Landroid/widget/CalendarView;)I
...
.method private updateSelectionPositions()V
    ...
    invoke-static {v1}, Landroid/widget/CalendarView;->access$2600(Landroid/widget/CalendarView;)Z
    ...
    .restart local v0       #selectedPosition:I
    :cond_4
    const/4 v1, 0x0
...
.method public getDayFromLocation(FLjava/util/Calendar;)Z
    ...
    #getter for: Landroid/widget/CalendarView;->bArabic:Z
    invoke-static {v2}, Landroid/widget/CalendarView;->access$2600(Landroid/widget/CalendarView;)Z
...
.method public init(III)V
    ...
    #getter for: Landroid/widget/CalendarView;->bArabic:Z
    invoke-static {v3}, Landroid/widget/CalendarView;->access$2600(Landroid/widget/CalendarView;)Z
    ...
    #getter for: Landroid/widget/CalendarView;->mTempDate:Ljava/util/Calendar;
    invoke-static {v7}, Landroid/widget/CalendarView;->access$2200(Landroid/widget/CalendarView;)Ljava/util/Calendar;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/widget/CalendarView;->access$3600(Landroid/widget/CalendarView;)I
