...
.method private doArpTest(I)Z
    ...
    iget-object v14, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mLinkProperties:Landroid/net/LinkProperties;
    ...
    iget-object v14, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mWifiInfo:Landroid/net/wifi/WifiInfo;
    ...
    invoke-static {v14}, Landroid/net/wifi/WifiWatchdogStateMachine;->log(Ljava/lang/String;)V

    :cond_2
    :try_start_0
    new-instance v9, Landroid/net/arp/ArpPeer;

    invoke-direct {v9, v5, v6, v8, v2}, Landroid/net/arp/ArpPeer;-><init>(Ljava/lang/String;Ljava/net/InetAddress;Ljava/lang/String;Ljava/net/InetAddress;)V

    .local v9, peer:Landroid/net/arp/ArpPeer;
    if-nez p1, :cond_5

    move-object/from16 v0, p0

    iget v14, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mArpPingTimeoutMs:I

    invoke-virtual {v9, v14}, Landroid/net/arp/ArpPeer;->doArp(I)[B
    ...
    const-string v15, "single ARP test result: "
    ...
    :cond_3
    :goto_1
    invoke-virtual {v9}, Landroid/net/arp/ArpPeer;->close()V

    .end local v9           #peer:Landroid/net/arp/ArpPeer;
    :goto_2
    return v13

    .end local v13           #success:Z
    .restart local v9       #peer:Landroid/net/arp/ArpPeer;
    :cond_4
    const/4 v13, 0x0
    ...
    iget v14, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mNumArpPings:I
    ...
    const-string v15, "full ARP test result: "
    ...
    iget v15, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mNumArpPings:I
    ...
    iget v14, v0, Landroid/net/wifi/WifiWatchdogStateMachine;->mMinArpResponses:I
    :try_end_0
    ...
    const-string v16, "ARP test initiation failure: "
