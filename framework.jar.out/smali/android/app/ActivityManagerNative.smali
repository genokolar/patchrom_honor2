...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v161, result:Landroid/app/IActivityManager$WaitResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v14           #profileFd:Landroid/os/ParcelFileDescriptor;
    .end local v15           #options:Landroid/os/Bundle;
    .end local v161           #result:Landroid/app/IActivityManager$WaitResult;
    :cond_2
    const/4 v14, 0x0
    ...
    .end local v167           #stopProfiling:Z
    :cond_1b
    const/16 v167, 0x0
    ...
    .local v174, thumbnail:Landroid/graphics/Bitmap;
    :goto_16
    ...
    .end local v174           #thumbnail:Landroid/graphics/Bitmap;
    :cond_1c
    const/16 v174, 0x0
    ...
    .local v160, res:Ljava/lang/String;
    :goto_17
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v160           #res:Ljava/lang/String;
    :cond_1d
    const/16 v160, 0x0
    ...
    .restart local v174       #thumbnail:Landroid/graphics/Bitmap;
    :goto_23
    sget-object v5, Landroid/text/TextUtils;->CHAR_SEQUENCE_CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .local v162, results:Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v40           #resultCode:I
    .end local v100           #b:Landroid/os/IBinder;
    .end local v162           #results:Landroid/os/Bundle;
    :pswitch_38
    const-string v5, "android.app.IActivityManager"
    ...
    .local v159, requestedOrientation:I
    move-object/from16 v0, p0
    ...
    .end local v49           #token:Landroid/os/IBinder;
    .end local v159           #requestedOrientation:I
    :pswitch_3b
    const-string v5, "android.app.IActivityManager"
    ...
    .local v160, res:Landroid/content/IIntentSender;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    if-eqz v160, :cond_37

    invoke-interface/range {v160 .. v160}, Landroid/content/IIntentSender;->asBinder()Landroid/os/IBinder;
    ...
    .end local v160           #res:Landroid/content/IIntentSender;
    :cond_35
    const/16 v72, 0x0
    ...
    .restart local v15       #options:Landroid/os/Bundle;
    .restart local v160       #res:Landroid/content/IIntentSender;
    :cond_37
    const/4 v5, 0x0
    ...
    .local v170, tag:Ljava/lang/String;
    new-instance v106, Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    .end local v106           #ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    .end local v160           #res:Z
    .end local v170           #tag:Ljava/lang/String;
    :pswitch_5b
    const-string v5, "android.app.IActivityManager"
    ...
    .local v160, res:[Landroid/os/Debug$MemoryInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v148           #pids:[I
    .end local v160           #res:[Landroid/os/Debug$MemoryInfo;
    :pswitch_6f
    const-string v5, "android.app.IActivityManager"
    ...
    .end local v161           #result:Z
    .end local v168           #subTaskIndex:I
    .end local v173           #taskId:I
    :pswitch_86
    const-string v5, "android.app.IActivityManager"
    ...
    check-cast v171, Landroid/content/Intent;

    .local v171, target:Landroid/content/Intent;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v49           #token:Landroid/os/IBinder;
    .end local v160           #res:Z
    .end local v171           #target:Landroid/content/Intent;
    :pswitch_93
    const-string v5, "android.app.IActivityManager"
