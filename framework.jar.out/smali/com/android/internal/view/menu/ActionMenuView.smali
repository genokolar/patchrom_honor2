...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/view/menu/ActionMenuView;->isArFa:Z
...
.method private needsDividerBefore(ILandroid/view/View;Z)Z
    ...
    iget-boolean v6, p0, Lcom/android/internal/view/menu/ActionMenuView;->isArFa:Z

    if-nez v6, :cond_7

    if-nez p1, :cond_5

    instance-of v6, p2, Lcom/android/internal/view/menu/ActionMenuItemView;
    ...
    check-cast v6, Lcom/android/internal/view/menu/ActionMenuView$ActionMenuChildView;

    invoke-interface {v6}, Lcom/android/internal/view/menu/ActionMenuView$ActionMenuChildView;->needsDividerBefore()Z
    ...
    .local v4, isHaveMenuItem:Z
    :goto_0
    if-nez v4, :cond_1

    if-nez p1, :cond_1

    instance-of v6, p2, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;
    ...
    iget v6, v6, Landroid/content/pm/ActivityInfo;->uiOptions:I
    ...
    .end local v4           #isHaveMenuItem:Z
    :cond_4
    :goto_2
    return p3

    .end local v5           #isSlip:Z
    :cond_5
    const/4 v4, 0x0

    .restart local v4       #isHaveMenuItem:Z
    goto :goto_0

    .restart local v5       #isSlip:Z
    :cond_6
    move v5, v8
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/view/menu/ActionMenuView;->getChildAt(I)Landroid/view/View;
