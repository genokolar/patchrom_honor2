...
.method private checkStatusBarTranslucent(Landroid/view/WindowManager$LayoutParams;)V
    ...
    new-instance v3, Lcom/android/internal/policy/impl/PhoneWindowManager$22;

    invoke-direct {v3, p0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager$22;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Z)V
...
.method public beginLayoutLw(III)V
    ...
    sget-object v22, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTmpVisibleFrame:Landroid/graphics/Rect;

    .local v22, vf:Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    .end local v18           #needHideNaviBar:Z
    :cond_2
    :goto_5
    move-object/from16 v0, p0
    ...
    invoke-interface {v3, v0, v13, v1, v2}, Landroid/view/WindowManagerPolicy$WindowState;->computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    .end local v14           #isSBTranslucent:Z
    :cond_9
    return-void

    .end local v17           #navVisible:Z
    :cond_a
    const/16 v17, 0x0

    goto/16 :goto_0

    .restart local v17       #navVisible:Z
    :cond_b
    move-object/from16 v0, p0
    ...
    .restart local v18       #needHideNaviBar:Z
    :cond_f
    const/16 v17, 0x0
    ...
    iget v15, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mExternalDisplayWidth:I
    ...
    invoke-virtual {v3, v15, v4, v0, v1}, Landroid/graphics/Rect;->set(IIII)V
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    invoke-direct {v4, p1, p0, p4}, Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;-><init>(Landroid/content/Context;Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/LocalPowerManager;)V
    ...
    iget-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v4, v7, v6}, Landroid/provider/SettingsEx$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_2
    iput-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mUserStatusBarTranslucent:Z
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    sget v33, Lcom/huawei/permission/StubController;->isPermissionManagerPropertyOn:I
...
.method public isLockScreenDisabled()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;->isLockScreenDisabled()Z
